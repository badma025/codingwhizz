...
tags:
  ...
  - javascript
date: "2019-12-15"
keywords: SWR, HOOKS, JAVASCRIPT
description: SWR is a great package from Zeit to help make it easier to fetch remote data with hooks. It is based on the stale-while-revalidate RFC.
---
